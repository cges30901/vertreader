...
class Ui_StyleDialog(object):
    def setupUi(self, StyleDialog):
        ...
        self.btnVertical = QtWidgets.QRadioButton(StyleDialog)
        self.btnVertical.setChecked(True)
        self.btnVertical.setObjectName("btnVertical")
        self.verticalLayout_2.addWidget(self.btnVertical)
        self.btnHorizontal = QtWidgets.QRadioButton(StyleDialog)
        self.btnHorizontal.setObjectName("btnHorizontal")
        self.verticalLayout_2.addWidget(self.btnHorizontal)
    ...
    def retranslateUi(self, StyleDialog):
        ...
        self.btnVertical.setText(_translate("StyleDialog", "Vertical writing"))
        self.btnHorizontal.setText(_translate("StyleDialog", "Horizontal writing"))
